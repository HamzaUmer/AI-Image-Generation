        ...
        <section className="max-w-7xl mx-auto">
            <div>
                <h1 className='font-extrabold text-[#222328] text-[32px]'>
                    Artificial Intelligence World For Developer
                </h1>
                <p className='mt-2 text-[#666e75] text-[16px] max-w-[500px]'>
                    You can create any image you imagine using this AI application.
                </p>
            </div>
            <div className='mt-16'>
                <FormField 
                LabelName = "Search AI Images"
                type="text"
                name= "text"
                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div className='grid lg:grid-cols-4 sm:grid-cols-3 xs:grid-cols-2 grid-cols-1 gap-3'>
                            {searchText ? (
                                <RenderCard data={searchedResults}
